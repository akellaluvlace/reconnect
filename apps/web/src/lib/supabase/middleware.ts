...
const PUBLIC_PATHS = ["/login", "/register", "/forgot-password", "/verify", "/auth/callback", "/auth/collaborator", "/api/health", "/api/cron", "/api/feedback/collaborator", "/api/webhooks/recall", "/share"];
